...
export const trialCopy: Record<Locale, TrialCopy> = {
  en: {
    ...
    intro: "Your private preview has no timer. The 7-day period starts after you choose a package and confirm.",
  ...
  el: {
    ...
    intro: "Το ιδιωτικό preview σου δεν έχει χρονόμετρο. Η περίοδος των 7 ημερών ξεκινά αφού επιλέξεις πακέτο και επιβεβαιώσεις.",
  ...
  fr: {
    ...
    intro: "Votre aperçu privé n’a pas de minuteur. La période de 7 jours commence après le choix d’un forfait et votre confirmation.",
  ...
  de: {
    ...
    intro: "Deine private Vorschau hat keinen Timer. Die 7 Tage beginnen nach Paketauswahl und Bestätigung.",
  ...
  es: {
    ...
    intro: "Tu vista previa privada no tiene temporizador. El periodo de 7 días empieza tras elegir un paquete y confirmarlo.",
  ...
  it: {
    ...
    intro: "La tua anteprima privata non ha un timer. Il periodo di 7 giorni inizia dopo la scelta del pacchetto e la conferma.",
