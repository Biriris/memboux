...
export const trialCopy: Record<Locale, TrialCopy> = {
  en: {
    ...
    intro: "Your private preview has no timer. The 37-day Memboux Free period starts after you choose a package and confirm.",
  ...
  el: {
    ...
    intro: "Το ιδιωτικό preview σου δεν έχει χρονόμετρο. Οι 37 ημέρες του Memboux Free ξεκινούν αφού επιλέξεις πακέτο και επιβεβαιώσεις.",
  ...
  fr: {
    ...
    intro: "Votre aperçu privé n’a pas de minuteur. Les 37 jours de Memboux Free commencent après le choix d’un forfait et votre confirmation.",
  ...
  de: {
    ...
    intro: "Deine private Vorschau hat keinen Timer. Die 37 Tage von Memboux Free beginnen nach Paketauswahl und Bestätigung.",
  ...
  es: {
    ...
    intro: "Tu vista previa privada no tiene temporizador. Los 37 días de Memboux Free empiezan tras elegir un paquete y confirmarlo.",
  ...
  it: {
    ...
    intro: "La tua anteprima privata non ha un timer. I 37 giorni di Memboux Free iniziano dopo la scelta del pacchetto e la conferma.",
