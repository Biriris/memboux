...
export function trialUploadGuardScript(locale: Locale) {
  const copy: Record<Locale, { status: string; full: string; exceeded: string }> = {
    en: { status: "Memboux Free · {used}/{limit} photo or video slots used.", full: "This event’s Memboux Free allowance has reached {limit} photos and videos. Existing memories are safe. The organizer can activate a package to continue uploads.", exceeded: "The selected files exceed the remaining Memboux Free upload slots." },
    el: { status: "Memboux Free · χρησιμοποιήθηκαν {used}/{limit} θέσεις φωτογραφιών ή βίντεο.", full: "Το Memboux Free αυτού του event έφτασε τις {limit} φωτογραφίες και βίντεο. Οι αναμνήσεις που ανέβηκαν είναι ασφαλείς. Ο διοργανωτής μπορεί να ενεργοποιήσει πακέτο για να συνεχιστούν τα uploads.", exceeded: "Τα επιλεγμένα αρχεία ξεπερνούν τις διαθέσιμες θέσεις upload του Memboux Free." },
    fr: { status: "Memboux Free · {used}/{limit} emplacements photo ou vidéo utilisés.", full: "Memboux Free a atteint {limit} photos et vidéos. Les souvenirs déjà ajoutés sont conservés. L’organisateur peut activer un forfait pour poursuivre les ajouts.", exceeded: "Les fichiers sélectionnés dépassent les emplacements Memboux Free restants." },
    de: { status: "Memboux Free · {used}/{limit} Foto- oder Video-Plätze belegt.", full: "Memboux Free hat {limit} Fotos und Videos erreicht. Bereits hochgeladene Erinnerungen sind sicher. Der Veranstalter kann ein Paket aktivieren, um Uploads fortzusetzen.", exceeded: "Die ausgewählten Dateien überschreiten die verbleibenden Memboux Free Plätze." },
    es: { status: "Memboux Free · {used}/{limit} espacios de foto o vídeo usados.", full: "Memboux Free ha alcanzado {limit} fotos y vídeos. Los recuerdos ya subidos están seguros. El organizador puede activar un paquete para continuar las subidas.", exceeded: "Los archivos seleccionados superan los espacios restantes de Memboux Free." },
    it: { status: "Memboux Free · {used}/{limit} spazi foto o video usati.", full: "Memboux Free ha raggiunto {limit} foto e video. I ricordi già caricati sono al sicuro. L’organizzatore può attivare un pacchetto per continuare i caricamenti.", exceeded: "I file selezionati superano gli spazi rimanenti di Memboux Free." },
  };
