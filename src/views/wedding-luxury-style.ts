export const weddingLuxuryStyles = `
  ...
  .w-menu-groups{display:grid;gap:clamp(2.5rem,6vw,5rem);margin-top:3rem}.w-menu-group>h3{margin:0;color:var(--w-accent);font-size:.72rem;font-weight:800;letter-spacing:.2em;text-transform:uppercase}.w-menu-courses{display:grid;gap:1.5rem;margin-top:1.25rem}.w-menu-courses article{border-top:1px solid color-mix(in srgb,var(--w-ink) 18%,transparent);padding-top:1.35rem}.w-menu-courses article h4{margin:0;font-family:var(--w-display);font-size:clamp(1.15rem,2vw,1.5rem);font-weight:600;line-height:1.25}.w-menu-courses article p{max-width:44rem;margin:.55rem 0 0;white-space:pre-line;font-size:clamp(.95rem,1.5vw,1.08rem);line-height:1.7;opacity:.78}
