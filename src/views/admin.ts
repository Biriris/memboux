...
export function adminShell(
  ...
  const menu = `<a href="/admin" class="${linkClass}">${locale === "el" ? "Βιβλιοθήκη events" : "Event library"}</a>
    <a href="/admin/users" class="${linkClass}">${locale === "el" ? "Εγγεγραμμένοι χρήστες" : "Registered users"}</a>
