...
const assetSets = {
  ...
  family: [generated("family-hero"), generated("family-candid"), generated("family-table")],
  travel: [marketing("trip-moments"), generated("travel-group"), generated("travel-phones")],
  corporate: [generated("corporate-hero"), generated("corporate-stage"), generated("corporate-networking")],
  graduation: [generated("graduation-hero"), generated("graduation-caps"), generated("graduation-family")],
  community: [generated("community-hero"), generated("community-dance"), generated("community-group")],
  remembrance: [generated("memorial-hero"), generated("remembrance-story"), generated("remembrance-group")],
} as const;
...
const descriptions: Record<Locale, Record<keyof typeof assetSets, readonly [string, string, string]>> = {
  el: {
    ...
    corporate: ["Συμμετέχοντες συζητούν σε ένα σύγχρονο επαγγελματικό event", "Οι συμμετέχοντες παρακολουθούν την ομιλήτρια στην ίδια σκηνή", "Στελέχη συζητούν στον ίδιο χώρο μετά την παρουσίαση"],
    graduation: ["Νέοι απόφοιτοι φωτογραφίζονται μετά την τελετή", "Οι ίδιοι απόφοιτοι γιορτάζουν σηκώνοντας τα καπέλα τους", "Οι απόφοιτοι φωτογραφίζονται με τις οικογένειές τους"],
  ...
  en: {
    ...
    corporate: ["Attendees connect at a contemporary professional event", "Attendees watch the speaker on the same stage", "Professionals reconnect after the presentation"],
    graduation: ["Young graduates take photos after their ceremony", "The same graduates celebrate by lifting their caps", "Graduates take photographs with their families"],
