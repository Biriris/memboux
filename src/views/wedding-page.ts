...
export function renderWeddingPage(input: {
  ...
  return page(names, `${renderedBody}${countdownScript}${experienceScripts}`, {
    ...
    additionalHead: `<link href="https://fonts.googleapis.com/css2?family=EB+Garamond:ital,wght@0,400;0,500;1,400&family=GFS+Didot&family=Noto+Serif:ital,wght@0,300;0,400;1,300&display=swap" rel="stylesheet">${demo ? "<style>html{scroll-behavior:smooth}</style>" : ""}`,
