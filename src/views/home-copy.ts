...
export const additionalHomeCopy: Partial<Record<Locale, HomeCopy>> = {
  fr: {
    ...
    eventKinds: "Pour les moments qui méritent de rester ensemble", eventChips: ["Voyages", "Anniversaires", "EVG / EVJF", "Fêtes", "Amis", "Communautés"],
  ...
  de: {
    ...
    eventKinds: "Für Momente, die zusammengehören", eventChips: ["Reisen", "Geburtstage", "JGA", "Partys", "Freunde", "Gruppen"],
  ...
  es: {
    ...
    eventKinds: "Para los momentos que merecen seguir juntos", eventChips: ["Viajes", "Cumpleaños", "Despedidas", "Fiestas", "Amigos", "Comunidades"],
  ...
  it: {
    ...
    eventKinds: "Per i momenti che meritano di restare insieme", eventChips: ["Viaggi", "Compleanni", "Addio al celibato", "Feste", "Amici", "Community"],
