...
function guestPlannerPage(input: {
  ...
  const normalizedBody = body.replace(
    el ? "Για αποστολή προσκλήσεων, δημοσίευσε πρώτα τον γάμο και ενεργοποίησε trial ή πρόσβαση καλεσμένων." : "Publish the wedding and activate trial or guest access before sending invitations.",
    el ? "Για αποστολή προσκλήσεων, δημοσίευσε πρώτα τον γάμο και ενεργοποίησε το πακέτο του event." : "Publish the wedding and activate the event package before sending invitations.",
  );
  const enhancedBody = normalizedBody
