...
export const WEDDING_CATALOG_VERSION = "wedding-2026-v2";
...
export const weddingFeatureCatalog = [
  ...
  { key: "calendar_links", priceMinor: 500, available: true, title: text("Add to calendar", "Προσθήκη στο ημερολόγιο", "Ajouter au calendrier", "Zum Kalender hinzufügen", "Añadir al calendario", "Aggiungi al calendario"), description: text("Private calendar files for the ceremony and reception.", "Ιδιωτικά αρχεία ημερολογίου για την τελετή και τη δεξίωση.", "Fichiers calendrier privés pour la cérémonie et la réception.", "Private Kalenderdateien für Zeremonie und Feier.", "Archivos privados de calendario para la ceremonia y la celebración.", "File calendario privati per la cerimonia e il ricevimento.") },
