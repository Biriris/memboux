...
const creationAnswers: Record<SupportedLanguage, string> = {
  ...
  fr: "Pour créer un événement :\n1. Connectez-vous et ouvrez « Mes événements ».\n2. Choisissez « Nouvel événement » puis le type d’événement.\n3. Terminez la configuration guidée et vérifiez l’aperçu complet.\n4. Lorsque vous êtes prêt à inviter des personnes, activez Memboux Free.\n\nLa création et l’aperçu ne nécessitent ni paiement ni carte. Memboux Free dure 37 jours, comprend 50 emplacements d’ajout au total et ne permet pas de télécharger les originaux.",
  de: "So erstellst du ein Event:\n1. Melde dich an und öffne „Meine Events“.\n2. Wähle „Neues Event“ und den Eventtyp.\n3. Schließe die geführte Einrichtung ab und prüfe die vollständige Vorschau.\n4. Aktiviere Memboux Free, sobald du Gäste einladen möchtest.\n\nErstellung und Vorschau erfordern weder Zahlung noch Karte. Memboux Free läuft 37 Tage, umfasst insgesamt 50 Upload-Plätze und enthält keine Original-Downloads.",
  es: "Para crear un evento:\n1. Inicia sesión y abre «Mis eventos».\n2. Pulsa «Nuevo evento» y elige el tipo.\n3. Completa la configuración guiada y revisa la vista previa completa.\n4. Cuando quieras invitar a otras personas, activa Memboux Free.\n\nCrear y previsualizar no requiere pago ni tarjeta. Memboux Free dura 37 días, incluye 50 espacios de subida totales y no permite descargar originales.",
  it: "Per creare un evento:\n1. Accedi e apri «I miei eventi».\n2. Seleziona «Nuovo evento» e scegli il tipo.\n3. Completa la configurazione guidata e controlla l’anteprima completa.\n4. Quando vuoi invitare gli ospiti, attiva Memboux Free.\n\nCreazione e anteprima non richiedono pagamento o carta. Memboux Free dura 37 giorni, include 50 spazi di caricamento totali e non consente il download degli originali.",
};
...
const trialAnswers: Record<SupportedLanguage, string> = {
  ...
  fr: "Le propriétaire choisit un forfait événement et active lui-même Memboux Free. Il dure 37 jours, comprend 50 emplacements d’ajout de photos ou vidéos au total et ne permet pas de télécharger les originaux. Supprimer un fichier ne rend pas son emplacement. Les paiements ne sont pas encore actifs et aucune carte n’est demandée.",
  de: "Der Owner wählt ein Event-Paket und aktiviert Memboux Free ausdrücklich selbst. Es läuft 37 Tage, umfasst insgesamt 50 Upload-Plätze für Fotos und Videos und schaltet keine Original-Downloads frei. Durch Löschen wird kein Platz zurückgegeben. Zahlungen sind noch nicht aktiv und es werden keine Kartendaten verlangt.",
  es: "El owner elige un paquete para el evento y activa expresamente Memboux Free. Dura 37 días, permite 50 espacios totales para fotos o vídeos y no desbloquea descargas originales. Eliminar un archivo no devuelve su espacio. Los pagos aún no están activos y no se solicitan datos de tarjeta.",
  it: "L’owner sceglie un pacchetto per l’evento e attiva esplicitamente Memboux Free. Dura 37 giorni, consente 50 spazi totali per foto o video e non sblocca i download originali. Eliminare un file non restituisce lo spazio. I pagamenti non sono ancora attivi e non vengono richiesti dati della carta.",
};
