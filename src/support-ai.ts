...
- The owner selects an event package and explicitly activates the trial when ready. It lasts 7 days, allows 20 lifetime media
...
const trialAnswers: Record<SupportedLanguage, string> = {
  el: "Ο owner επιλέγει πακέτο event και ενεργοποιεί ρητά το trial. Διαρκεί 7 ημέρες, επιτρέπει 20 συνολικές θέσεις για φωτογραφίες και βίντεο και δεν ξεκλειδώνει λήψεις πρωτοτύπων. Αν διαγραφεί ένα αρχείο, η θέση trial δεν επιστρέφεται. Οι πληρωμές δεν είναι ακόμη ενεργές και δεν ζητούνται στοιχεία κάρτας.",
  en: "The owner selects an event package and explicitly activates the trial. It lasts 7 days, allows 20 lifetime photo/video upload slots and does not unlock original downloads. Deleting a file does not restore a trial slot. Payments are not active yet and no card details are requested.",
