...
- The owner explicitly activates the trial when ready. It lasts 14 days, allows 20 lifetime media
...
const creationAnswers: Record<SupportedLanguage, string> = {
  el: "Για να δημιουργήσεις event:\n1. Συνδέσου και άνοιξε «Τα events μου».\n2. Πάτησε «Νέο event» και επίλεξε τον τύπο εκδήλωσης.\n3. Συμπλήρωσε τα βήματα του wizard και έλεγξε το πλήρες preview.\n4. Όταν είσαι έτοιμος να καλέσεις κόσμο, ενεργοποίησε εσύ το trial.\n\nΗ δημιουργία και το preview δεν απαιτούν πληρωμή ή κάρτα. Το trial διαρκεί 14 ημέρες, έχει 20 συνολικές θέσεις upload και δεν επιτρέπει λήψη πρωτοτύπων.",
  en: "To create an event:\n1. Sign in and open “My events”.\n2. Select “New event” and choose the event type.\n3. Complete the guided setup and review the full preview.\n4. When you are ready to invite guests, explicitly activate the trial.\n\nCreation and preview do not require payment or a card. The trial lasts 14 days, includes 20 lifetime upload slots and does not include original downloads.",
  fr: "Pour créer un événement :\n1. Connectez-vous et ouvrez « Mes événements ».\n2. Choisissez « Nouvel événement » puis le type d’événement.\n3. Terminez la configuration guidée et vérifiez l’aperçu complet.\n4. Lorsque vous êtes prêt à inviter des personnes, activez vous-même l’essai.\n\nLa création et l’aperçu ne nécessitent ni paiement ni carte. L’essai dure 14 jours, comprend 20 emplacements d’ajout au total et ne permet pas de télécharger les originaux.",
  de: "So erstellst du ein Event:\n1. Melde dich an und öffne „Meine Events“.\n2. Wähle „Neues Event“ und den Eventtyp.\n3. Schließe die geführte Einrichtung ab und prüfe die vollständige Vorschau.\n4. Aktiviere den Test selbst, sobald du Gäste einladen möchtest.\n\nErstellung und Vorschau erfordern weder Zahlung noch Karte. Der Test läuft 14 Tage, umfasst insgesamt 20 Upload-Plätze und enthält keine Original-Downloads.",
  es: "Para crear un evento:\n1. Inicia sesión y abre «Mis eventos».\n2. Pulsa «Nuevo evento» y elige el tipo.\n3. Completa la configuración guiada y revisa la vista previa completa.\n4. Cuando quieras invitar a otras personas, activa tú mismo la prueba.\n\nCrear y previsualizar no requiere pago ni tarjeta. La prueba dura 14 días, incluye 20 espacios de subida totales y no permite descargar originales.",
  it: "Per creare un evento:\n1. Accedi e apri «I miei eventi».\n2. Seleziona «Nuovo evento» e scegli il tipo.\n3. Completa la configurazione guidata e controlla l’anteprima completa.\n4. Quando vuoi invitare gli ospiti, attiva tu stesso la prova.\n\nCreazione e anteprima non richiedono pagamento o carta. La prova dura 14 giorni, include 20 spazi di caricamento totali e non consente il download degli originali.",
};

const trialAnswers: Record<SupportedLanguage, string> = {
  el: "Το trial ενεργοποιείται μόνο όταν το επιλέξει ο owner. Διαρκεί 14 ημέρες, επιτρέπει 20 συνολικές θέσεις για φωτογραφίες και βίντεο και δεν ξεκλειδώνει λήψεις πρωτοτύπων. Αν διαγραφεί ένα αρχείο, η θέση trial δεν επιστρέφεται. Οι πληρωμές δεν είναι ακόμη ενεργές και δεν ζητούνται στοιχεία κάρτας.",
  en: "The owner activates the trial explicitly. It lasts 14 days, allows 20 lifetime photo/video upload slots and does not unlock original downloads. Deleting a file does not restore a trial slot. Payments are not active yet and no card details are requested.",
  fr: "Le propriétaire active lui-même l’essai. Il dure 14 jours, comprend 20 emplacements d’ajout de photos ou vidéos au total et ne permet pas de télécharger les originaux. Supprimer un fichier ne rend pas son emplacement. Les paiements ne sont pas encore actifs et aucune carte n’est demandée.",
  de: "Der Owner aktiviert den Test ausdrücklich selbst. Er läuft 14 Tage, umfasst insgesamt 20 Upload-Plätze für Fotos und Videos und schaltet keine Original-Downloads frei. Durch Löschen wird kein Platz zurückgegeben. Zahlungen sind noch nicht aktiv und es werden keine Kartendaten verlangt.",
  es: "El owner activa expresamente la prueba. Dura 14 días, permite 20 espacios totales para fotos o vídeos y no desbloquea descargas originales. Eliminar un archivo no devuelve su espacio. Los pagos aún no están activos y no se solicitan datos de tarjeta.",
  it: "L’owner attiva esplicitamente la prova. Dura 14 giorni, consente 20 spazi totali per foto o video e non sblocca i download originali. Eliminare un file non restituisce lo spazio. I pagamenti non sono ancora attivi e non vengono richiesti dati della carta.",
};
