...
export const eventUiCopy: Record<Locale, EventUiCopy> = {
  en: {
    ...
    trialText: "A complete private preview, 7 days and up to 20 files. Upgrade unlocks a larger collection and long-term access.",
    ...
    minimalDescription: "Clean & contemporary", trialSummary: "No card · 7 days · 20 files", eventPreview: "Event preview",
  ...
  el: {
    ...
    trialText: "Πλήρης ιδιωτική προεπισκόπηση, 7 ημέρες και έως 20 αρχεία. Η αναβάθμιση ξεκλειδώνει μεγαλύτερη συλλογή και μακροχρόνια πρόσβαση.",
    ...
    minimalDescription: "Καθαρό & σύγχρονο", trialSummary: "Χωρίς κάρτα · 7 ημέρες · 20 αρχεία", eventPreview: "Προεπισκόπηση εκδήλωσης",
  ...
  fr: {
    ...
    trialText: "Un aperçu privé complet pendant 7 jours, avec jusqu’à 20 fichiers. La mise à niveau débloque une collection plus grande et un accès durable.",
    ...
    minimalDescription: "Épuré et contemporain", trialSummary: "Sans carte · 7 jours · 20 fichiers", eventPreview: "Aperçu de l’événement",
  ...
  de: {
    ...
    trialText: "Eine vollständige private Vorschau für 7 Tage und bis zu 20 Dateien. Ein Upgrade schaltet eine größere Sammlung und dauerhaften Zugriff frei.",
    ...
    minimalDescription: "Klar und modern", trialSummary: "Keine Karte · 7 Tage · 20 Dateien", eventPreview: "Eventvorschau",
  ...
  es: {
    ...
    trialText: "Una vista previa privada completa durante 7 días y hasta 20 archivos. La mejora desbloquea una colección mayor y acceso duradero.",
    ...
    minimalDescription: "Limpio y contemporáneo", trialSummary: "Sin tarjeta · 7 días · 20 archivos", eventPreview: "Vista previa del evento",
  ...
  it: {
    ...
    trialText: "Un’anteprima privata completa per 7 giorni e fino a 20 file. L’upgrade sblocca una raccolta più grande e un accesso duraturo.",
    ...
    minimalDescription: "Pulito e contemporaneo", trialSummary: "Nessuna carta · 7 giorni · 20 file", eventPreview: "Anteprima dell’evento",
