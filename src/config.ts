...
export const MAX_LEGACY_FILE_SIZE = 100 * 1024 * 1024;
...
// Keep enough headroom below Cloudflare's 100 MB request limit on Free/Pro.
export const FAST_UPLOAD_MAX_SIZE = 64 * 1024 * 1024;
