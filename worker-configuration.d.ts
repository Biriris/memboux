/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: bbb44e26f2369b2828f89d08ad7c9984)
...
interface __BaseEnv_Env {
	...
	DRIVE_BACKUP_WORKFLOW: Workflow<Parameters<import("./src/index").GoogleDriveBackupWorkflow['run']>[0]['payload']>;
	DROPBOX_BACKUP_WORKFLOW: Workflow<Parameters<import("./src/index").DropboxBackupWorkflow['run']>[0]['payload']>;
	CLOUD_RESTORE_WORKFLOW: Workflow<Parameters<import("./src/index").CloudEventRestoreWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SUPPORT_EMAIL">> {}
}
